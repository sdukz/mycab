...
if(($DriverId !=''))
{
	$query = "SELECT 
	          `driver_id`, `driver_name`, `driver_image`, `mobile_no`, `latitude`, `longitude`, `taxi_no`,`licance_id`,
	           `taxi_model`, `taxi_color`, `no_of_seat`,`busy`,`luggage_carrier`, `child_seat`, `radious`,`balance`,
	           `min_search_amount`,`max_search_amount`, `device_type`,`created_date`, `updated_date`  
